    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            app: {
                ...
                src: [
                    // Load core
                    '<%= clientFolder %>/src/core/**/module.js',
                    '<%= clientFolder %>/src/core/core.js',
                    '<%= clientFolder %>/src/core/**/*.js',

                    // Load app
                    '<%= clientFolder %>/src/app/**/module.js',
                    '<%= clientFolder %>/src/app/app.js',
                    '<%= clientFolder %>/src/app/**/*.js',

                    // Load configuration
                    '<%= clientFolder %>/src/parameters.js',

                    // Load routes
                    '<%= clientFolder %>/src/app/**/routes.js'
                ],
