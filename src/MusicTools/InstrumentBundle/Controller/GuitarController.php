...
class GuitarController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MusicToolsInstrumentBundle:Guitar')->findAll();
     ...
     * @Method("POST")
     * @Template("MusicToolsInstrumentBundle:Guitar:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MusicToolsInstrumentBundle:Guitar')->find($id);
